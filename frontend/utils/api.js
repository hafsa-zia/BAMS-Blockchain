...
export const updateDepartment = (id, updates) =>
  API.post(`/departments/${id}/update`, updates);
export const deleteDepartment = (id) =>
  API.post(`/departments/${id}/delete`);
...
export const updateClass = (id, updates) =>
  API.post(`/classes/${id}/update`, updates);
export const deleteClass = (id) =>
  API.post(`/classes/${id}/delete`);
...
export const updateStudent = (id, updates) =>
  API.post(`/students/${id}/update`, updates);
export const deleteStudent = (id) =>
  API.post(`/students/${id}/delete`);
export const getStudentChain = (id) =>
  API.get(`/students/${id}/chain`);

// --------------- Attendance ---------------
export const markAttendance = ({ studentId, status }) =>
  API.post("/attendance/mark", { studentId, status });

export const getAttendanceForStudent = (id) =>
  API.get(`/attendance/student/${id}`);

export const getAttendanceForClassOnDate = (classId, date) =>
  API.get(`/attendance/class/${classId}/day/${date}`);
